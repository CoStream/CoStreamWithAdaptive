...
/**
 * 基于Tuple4<String, String, String, String>实现的堆外元组序列化器
 */
public class CommonJoinUnionTypeSerializerForTuple4 implements CommonJoinUnionTypeSerializer<Tuple4<String, String, String, String>, Tuple4<String, String, String, String>> {
