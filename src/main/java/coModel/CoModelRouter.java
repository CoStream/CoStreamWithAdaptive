...
public class CoModelRouter <F, S> extends CommonRouter<F, S> {
    ...
    private int R_copiesNum;
    private int S_copiesNum;
    ...
    //获取logger对象用于日志记录
    private static final Logger logger = Logger.getLogger(CoModelRouter.class.getName());


    /**
     * 通用的有参构造
     */
    public CoModelRouter(Time r_TimeWindows, Time s_TimeWindows, double r_surpass_S, double r_behind_S, KeySelector<F, Double> keySelector_R, KeySelector<S, Double> keySelector_S) {
