 ...
 */
public class ExperimentExecutorForSyntheticAndEqualPrecise implements Serializable {
    //用于标识是在进行哪个实验
    ...
    //获取logger对象用于日志记录
    private static final Logger logger = Logger.getLogger(ExperimentExecutorForSyntheticAndEqualPrecise.class.getName());
     ...
     * @param args 程序的输入参数
     */
    public ExperimentExecutorForSyntheticAndEqualPrecise(String experimentModel, String[] args) {
    ...
    public void startExperiment() throws Exception {
        ...
        logger.info(">>>开始执行ExperimentExecutorForSyntheticAndEqualPrecise实验");
        System.out.println("在该实验中，计算每个元组的延迟的方式是获取的系统的时间，因此计算的延迟时间是准确的");
